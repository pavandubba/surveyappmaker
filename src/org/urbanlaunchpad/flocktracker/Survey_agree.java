...
public class Survey_agree extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_survey_agree);
		// Show the Up button in the action bar.
		setupActionBar();
		findViewById(R.id.iagree_b).setOnClickListener(
				new View.OnClickListener() {
					@Override
					public void onClick(View view) {
						startActivity(Gender_choice.class);
					}
				});
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.survey_agree, menu);
		return true;
	}
