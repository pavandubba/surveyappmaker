...
public class Surveyor extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        trackerSubmissionQueue = new HashSet<String>(Iniconfig.prefs.getStringSet(
                "trackerSubmissionQueue", new HashSet<String>()));
        surveySubmissionQueue = new HashSet<String>(Iniconfig.prefs.getStringSet(
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        if (savingSurveySubmission) { // connecting for submitting survey and not
            // tracking
            new Thread(new Runnable() {
                public void run() {
                    saveSurvey();
