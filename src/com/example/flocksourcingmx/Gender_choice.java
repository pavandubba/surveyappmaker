...
public class Gender_choice extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setupActionBar();
		findViewById(R.id.female_button).setOnClickListener(
				new View.OnClickListener() {
					@Override
					public void onClick(View view) {
						startActivity(Survey.class);
					}
				});
		findViewById(R.id.male_button).setOnClickListener(
				new View.OnClickListener() {
					@Override
					public void onClick(View view) {
						startActivity(Survey.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.gender_choice, menu);
		return true;
	}
