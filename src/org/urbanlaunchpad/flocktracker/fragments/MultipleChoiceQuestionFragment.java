...
public class MultipleChoiceQuestionFragment extends QuestionFragment {
    ...
    private void unCheckView(LinearLayout view) {
        ...
        answerText.setTextColor(getResources().getColor(R.color.text_color_light));
    }
    ...
    private void checkView(LinearLayout view) {
        ...
        TextView answerText = (TextView) view.findViewById(ANSWER_TAG);
        answerText.setTextColor(getResources().getColor(R.color.answer_selected));
        answerText.requestFocus();
    }

    public void setupLayout(boolean hasOther) throws JSONException {
        final int numAnswers = hasOther ? jquestion.getJSONArray("Answers").length() :
        ...
        for (int i = 0; i < jsonAnswers.length(); i++) {
            ...
            answerTextView.setTypeface(Typeface.create("sans-serif-light", Typeface.NORMAL));
        ...
        if (hasOther) {
            ...
            otherET.setTypeface(Typeface.create("sans-serif-light", Typeface.NORMAL));
            LinearLayout.LayoutParams layoutParamsText = new LinearLayout.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
            layoutParamsText.gravity = Gravity.CENTER_VERTICAL;
